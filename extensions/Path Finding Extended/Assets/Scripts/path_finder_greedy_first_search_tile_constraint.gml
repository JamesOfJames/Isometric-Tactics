...
while (!ds_priority_empty(frontier))
   ...
   var NeighbourList = path_finder_grid_neighbours_directional_constraints(Graph,path_finder_grid_cell_get_x(Graph,current),path_finder_grid_cell_get_y(Graph,current),Con) ;
