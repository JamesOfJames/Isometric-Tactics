///path_finder_dijkstra_search_8d_weighted(graph,weighted graph, start, goal,return mode,MovementWeights)
/*
   ...
   while (!ds_priority_empty(frontier))
    ...
    //We look at the first cell in the frontier
      ...
      for (var i = 0 ; i < Size ; i++)
        ...
        var Cost = G[#1 + sign(lengthdir_x(1,Dir))*1,1 + sign(lengthdir_y(1,Dir))*1] ;
