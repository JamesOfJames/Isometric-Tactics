///path_finder_dijkstra_search_constraint(graph,weighted graph, start, goal,constraints,return mode)
/*
   ...
   while (!ds_priority_empty(frontier))
    ...
    //We look at the first cell in the frontier
      ...
      for (var i = 0 ; i < Size ; i++)
        ...
        new_cost = cost_so_far[?current] + path_finder_grid_cell_weight(WeightedGraph,next) ;
